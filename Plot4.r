...
#par(oma = c(0,0,1,0))
#par(mar = c(2,2,2,2))
plot(DataEPC$Time, DataEPC$Global_active_power, col = "black",  
     ylab= "Global Active Power", type = "l",
     xlab= "Days")
plot(DataEPC$Time, DataEPC$Voltage, col = "black",  
     ylab= "Voltage", type = "l",
     xlab= "Days")

plot(DataEPC2$Time, DataEPC2$Sub_metering_1, col = "black", 
...
plot(DataEPC$Time, DataEPC$Global_reactive_power, col = "black",  
